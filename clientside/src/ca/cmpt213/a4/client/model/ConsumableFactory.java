...
public class ConsumableFactory {
     ...
     */
    public Consumable getInstance(int id, int choice, String name, String note, double price, int amount, LocalDateTime expiryDate) {
        if (choice == 1) {
            return new FoodInfo(id, choice, name, note, price, amount, expiryDate);
        } else if (choice == 2) {
            return new DrinkInfo(id, choice, name, note, price, amount, expiryDate);
        }
        return null;
    }
}